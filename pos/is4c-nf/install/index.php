...
<tr>
    ...
    echo InstallUtilities::installSelectField('DBMS', $db_opts, array_slice($db_opts, 0, 1), InstallUtilities::INI_SETTING);
    ?>
    </td>
</tr>
<tr>
...
<tr>
    ...
    <?php
    $db_opts = \COREPOS\common\sql\Lib::getDrivers();
    echo InstallUtilities::installSelectField('mDBMS', $db_opts, array_slice($db_opts, 0, 1));
    ?>
    </td>
</tr>
<tr>
